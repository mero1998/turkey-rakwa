class AdsModel {
  int? code;
  bool? status;
  List<ClassifiedCategory>? classifiedCategory;

  AdsModel({this.code, this.status, this.classifiedCategory});

  AdsModel.fromJson(Map<String, dynamic> json) {
    print("code::: ${code}");
    code = json['code'];
    status = json['status'];
    if (json['classified_category'] != null) {
      classifiedCategory = <ClassifiedCategory>[];
      json['classified_category'].forEach((v) {
        classifiedCategory!.add(new ClassifiedCategory.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.classifiedCategory != null) {
      data['classified_category'] =
          this.classifiedCategory!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
...
class ClassifiedCategory {
  ...
  ClassifiedCategory.fromJson(Map<String, dynamic> json) {
