...
class AllArticalesGetxController extends GetxController  with StateMixin<List<ArticalModel>>, ScrollMixin{
  static AllArticalesGetxController get to => Get.find();
  RxBool isLoading = true.obs;

  RxList<ArticalModel> articalesMore = <ArticalModel>[].obs;
