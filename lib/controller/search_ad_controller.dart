...
//
// class SearchAdController extends GetxController with StateMixin<List<PaidItemsModel>>, ScrollMixin{
//   static SearchAdController get to => Get.find();
...
//         print("Query:: ${query}");
//    List<PaidItemsModel> list = await ItemApiController().searchItem(
//         cityId: cityId,
//         stateId: stateId,
...
//     isLoading.value = true;
//
//     print("from Classified");
//     List<PaidItemsModel> list = await ClassifiedApiController().searchClassified(
//         cityId: cityId,
//         stateId: stateId,
//         category: category ?? "",
